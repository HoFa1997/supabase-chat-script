...
CREATE TABLE public.messages (
  ...
  content                TEXT, -- Main content of the message.
  ...
  reply_to_message_id    UUID REFERENCES public.messages(id) ON DELETE SET NULL, -- ID of the message being replied to, if any.
